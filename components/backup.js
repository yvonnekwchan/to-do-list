...
import { Platform, StyleSheet, Text, Dimensions, Touchable, Button, View, KeyboardAvoidingView, TouchableWithoutFeedback, TextInput, TouchableOpacity, Keyboard, ScrollView } from 'react-native';
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={[styles.container, keyboardStatus == "hide" ? styles.brightBackground : styles.dimBackground]}>
        <View style={styles.tasksWrapper}>
          ...
          <View style={styles.items}>
            <View style={styles.header}>
              ...
              <Text style={styles.addIcon}><Ionicons name={"add"} size={26} color="#444" /></Text>
            </View>
            <View style={styles.taskList}>
              {
        ...
        {/* <Provider>
          <Button onPress={() => setShow(true)} title="show bottom sheet"></Button>
          <BottomSheet
            show={show}
